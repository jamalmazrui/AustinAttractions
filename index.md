...
subtitle: "Accessible Tourism Options During the 2026 NFB Convention"
author: "Jamal Mazrui"
date: "June 2026"
version: "v1.0.5"
lang: en-US
...
toc-depth: 3
abstract: |
  A focused, week-long guide to Austin attractions for blind and
  low-vision attendees of the 2026 National Federation of the Blind
  National Convention at the JW Marriott Austin (110 East 2nd Street).
  The convention runs Friday, July 3 through Wednesday, July 8, 2026.
  This guide spans the broader stay window of July 2 through July 9 to
  include arrival and departure days. Each entry leads with its walking
  distance from the JW Marriott and a "Nonvisual accessibility" line
  covering audio description, verbal description, braille, large print,
  and touch tours, with the phone number or email to call ahead where
  arrangement is required. A "Getting Around Austin" section covers
  the hotel's orientation, the Austin-Bergstrom International Airport
  transfer, rideshare, CapMetro public transit, accessible-wayfinding
  apps, and CapMetro Access paratransit.
---
...
### Congress Avenue Bridge Bat Emergence {#bats}
...
- More info: [Austin Bats viewing guide](https://www.austinbats.org/)

### The Contemporary Austin — Jones Center {#contemporary}
...
- More info: [The Contemporary Austin accessibility](https://thecontemporaryaustin.org/accessibility/)

### Esther's Follies {#esthers}
...
- More info: [Esther's Follies](https://www.esthersfollies.com/)

### Texas State Capitol Guided Tour {#capitol}
...
- More info: [Texas Capitol tours](https://tspb.texas.gov/plan/tours/tours.html)

## Friday, July 3, 2026

### Art Explorer Audio-Described Mural Tour {#art-explorer}
...
### Bat-Watching Cruise on Lady Bird Lake {#bat-cruise}
...
- More info: [Capital Cruises bat watching](https://capitalcruises.com/bat-watching/rates-and-times-for-our-bat-cruises-and-sightseeing-tours/) · [Lone Star Riverboat](https://lonestarriverboat.com/)

### Elephant Room {#elephant-room}
...
- More info: [Elephant Room](https://elephantroom.com/) · [calendar](https://elephantroom.com/calendar)

### Secret Food Tour: Downtown Austin {#food-tour}
...
- More info: [Austin food tours (Viator)](https://www.viator.com/Austin-tours/Food-Tours/d5021-g6-c80)
...
- More info: [UMLAUF Sculpture Garden & Museum](https://www.umlaufsculpture.org/visit)

## Saturday, July 4, 2026

### Austin Symphony Orchestra July 4th Concert & Fireworks (Star Spangled Fest) {#symphony}
...
- More info: [Star Spangled Fest](https://www.starspangledfest.com/)

### BookPeople and the 6th-and-Lamar Corner {#bookpeople}
...
- More info: [BookPeople](https://bookpeople.com/) · [24 Diner](https://www.24diner.com/)

_Also today:_ the Congress Avenue Bridge bats emerge shortly before the fireworks — full details under July 2. The Capitol is open for a self-paced holiday visit (confirm hours; braille and large-print brochure at the north entrance) — full details under July 2.

## Sunday, July 5, 2026

### Thinkery: Austin's Children's Museum {#thinkery}
...
- More info: [Thinkery](https://thinkeryaustin.org/)

### Bullock Texas State History Museum (Free First Sunday) {#bullock}
...
- More info: [Bullock Museum accessibility](https://www.thestoryoftexas.com/visit/accessibility/)

### Geraldine's Jazz Brunch {#geraldines}
...
- More info: [Geraldine's at Hotel Van Zandt](https://www.geraldinesaustin.com/)

_Also tonight:_ live jazz at the Elephant Room, a short walk away — full details under July 3.

## Monday, July 6, 2026

### Antone's "Blue Monday" Blues Jam {#antones}
...
- More info: [Antone's Nightclub](https://antonesnightclub.com/)

### Austin Duck Adventures {#duck}
...
- More info: [Austin Duck Adventures](https://austinducks.com/)

_Also tonight:_ the Elephant Room's Monday Night Jam — full details under July 3.

## Tuesday, July 7, 2026

### Blanton Museum of Art (Free Tuesday) {#blanton}
...
- More info: [Blanton Museum accessibility](https://blantonmuseum.org/visit/accessibility/)

### Barton Springs Pool at Zilker Park {#barton-springs}
...
- More info: [Visit Barton Springs Pool (City of Austin)](https://www.austintexas.gov/services/visit-barton-springs-pool)

### Summer Classic Film Series at the State Theatre {#film-series}
...
- More info: [Summer Classic Film Series](https://www.austintheatre.org/events/2026-summer-classic-film-series/)

_Also tonight:_ live jazz at the Elephant Room — full details under July 3.
...
### Downtown Walking Tour from the Austin Visitor Center {#walking-tour}
...
- More info: [Visit Austin downtown walking tours](https://www.austintexas.org/plan-a-trip/downtown-walking-tours/)

### Double Decker Austin Hop-On Hop-Off Bus Tour {#double-decker}
...
- More info: [Double Decker Austin](https://doubledeckeraustin.com/) · [Tour stops](https://doubledeckeraustin.com/stops/)
...
- More info: [Continental Club](https://continentalclub.com/)

_Also today:_ on a departure day, the free narrated Capitol tour runs from 9:30 a.m. (full details under July 2), the Visitor Center's guided walking tour departs at 10 a.m. (full details under July 8), and Esther's Follies plays again tonight (full details under July 2).
...
### Barbecue and Tex-Mex picks {#bbq-texmex}

- **[Franklin Barbecue](https://franklinbbq.com/)** (900 E 11th St) — Austin's most famous barbecue and widely treated as the state's gold standard. The line forms hours before opening and the brisket sells out, so treat it as a half-day mission rather than a quick lunch.
...
- **[The County Line on the Lake](https://countyline.com/lake-austin-tx/)** (5204 Ranch Rd 2222) — Barbecue in a converted lake lodge on Bull Creek, about 25 minutes from the hotel by car. Lively and kid-friendly, with family-style all-you-can-eat platters and famous homemade bread; busiest on weekends. Phone: (512) 346-3664.

### Budget food and grocery delivery {#budget-food}
...
### From the airport to the hotel {#getaround-airport}
...
- More info: [Waymo on Uber in Austin](https://www.uber.com/us/en/newsroom/waymo-on-uber-austin/)

### Public transit: CapMetro {#getaround-capmetro}
...
- More info: [CapMetro](https://www.capmetro.org/) · [plan a trip](https://www.capmetro.org/ride/plan/plan)

### Accessible wayfinding apps {#getaround-wayfinding}
...
- More info: [CapMetro accessible wayfinding](https://www.capmetro.org/accessible-wayfinding)

### ADA paratransit: CapMetro Access {#getaround-access}
...
- More info: [CapMetro Access](https://www.capmetro.org/access) · [Access Rider's Guide](https://www.capmetro.org/accessguide)

### Fitness center and pool at the JW Marriott {#getaround-fitness}
...
- More info: [JW Marriott Austin amenities](https://www.marriott.com/en-us/hotels/ausjw-jw-marriott-austin/overview/)

### Lady Bird Lake hike-and-bike trail {#getaround-trail}
The Ann and Roy Butler Hike-and-Bike Trail begins a few blocks south of the hotel and loops about 10 miles around Lady Bird Lake, including a boardwalk section over the water with an ADA-accessible pier. It is free, open daily 5 a.m. to midnight, and doubles as the walking route to the Congress Avenue Bridge bats and Vic Mathias Shores. The path is mostly level and well trafficked, which gives useful crowd-and-shoreline audio cues, but sections near Rainey Street and Interstate 35 are detoured for construction this season, so check the [Trail Conservancy detour map](https://thetrailconservancy.org/visit-the-trail/detours/) before a long walk or run.
- More info: [Ann and Roy Butler Hike-and-Bike Trail (City of Austin)](https://www.austintexas.gov/department/ann-and-roy-butler-hike-and-bike-trail-and-boardwalk-lady-bird-lake)

## Appendix A — Museums & Visual Art

- July 2 — [The Contemporary Austin — Jones Center](#contemporary) (downtown; free, with braille materials and access tours)
- July 3 — [UMLAUF Sculpture Garden & Museum](#umlauf) (touchable bronzes; Touch Tours by arrangement)
- July 5 — [Bullock Texas State History Museum](#bullock) (free First Sunday)
- July 5 — [Thinkery: Austin's Children's Museum](#thinkery) (hands-on children's museum)
- July 7 — [Blanton Museum of Art](#blanton) (free Tuesday)

## Appendix B — Jazz

- July 3 — [Elephant Room](#elephant-room) (live jazz nightly; full details here, including the July 6 Monday Night Jam)
- July 5 — [Geraldine's Jazz Brunch](#geraldines)

## Appendix C — Blues, Roots & Orchestral

- July 4 — [Austin Symphony Orchestra July 4th Concert & Fireworks](#symphony)
- July 6 — [Antone's "Blue Monday" Blues Jam](#antones)
- July 9 — [Continental Club](#continental)

## Appendix D — Comedy & Film

- July 2 — [Esther's Follies](#esthers) (Thursday–Saturday; also July 9)
- July 7 — [Summer Classic Film Series at the State Theatre](#film-series)

## Appendix E — Tours, Cruises & Food

- July 3 — [Art Explorer Audio-Described Mural Tour](#art-explorer)
- July 3 — [Bat-Watching Cruise on Lady Bird Lake](#bat-cruise)
- July 3 — [Secret Food Tour: Downtown Austin](#food-tour)
- July 6 — [Austin Duck Adventures](#duck)
- July 8 — [Downtown Walking Tour from the Austin Visitor Center](#walking-tour)
- July 8 — [Double Decker Austin Hop-On Hop-Off Bus Tour](#double-decker)
- Anytime — [Barbecue and Tex-Mex picks](#bbq-texmex)
- Anytime — [Budget food and grocery delivery](#budget-food)

## Appendix F — Landmarks & Outdoors

- July 2 — [Congress Avenue Bridge Bat Emergence](#bats) (nightly; full details here)
- July 2 — [Texas State Capitol](#capitol) (free guided weekday tours; full details here; self-guided on July 4)
- July 4 — [BookPeople and the 6th-and-Lamar Corner](#bookpeople) (Texas's largest independent bookstore)
- July 7 — [Barton Springs Pool at Zilker Park](#barton-springs) (spring-fed swimming)
- Anytime — [Lady Bird Lake hike-and-bike trail](#getaround-trail) (free 10-mile lakeside loop)

## Appendix G — Getting Around

- [From the airport to the hotel](#getaround-airport) (rideshare, CapMetro Airport Flyer route 20, Aira free at AUS)
- [Rideshare](#getaround-rideshare) (Uber, Lyft, and Waymo driverless rides via the Uber app)
- [Public transit: CapMetro](#getaround-capmetro) (buses and MetroRail; Transit app for planning)
- [Accessible wayfinding apps](#getaround-wayfinding) (NaviLens and Waymap)
- [ADA paratransit: CapMetro Access](#getaround-access) (door-to-door; 21-day visitor eligibility)
- [Fitness center and pool at the JW Marriott](#getaround-fitness)
...
- [ATXgo! by Art Spark Texas](https://atxgo.org/) — the standout. A Texas nonprofit's access guide to Austin's venues, museums, attractions, live-music and performing-arts spaces, and festivals, listing the specific accessibility information each venue has published plus a direct access contact for each one. It's a navigable website rather than a PDF, which reads cleanly with a screen reader. Start here.
- [NFB of Texas](https://nfbtx.org/) — the convention's host affiliate plans to post its own restaurant and touring guide by June 15, 2026; check the affiliate site as the convention approaches.
- [Visit Austin — Accessibility in Austin](https://www.austintexas.org/plan-a-trip/accessibility/) — the city tourism bureau's official accessibility page: airport services, the Get There ATX mobility-and-transit planner, and venue notes (for example, it confirms the Capitol's braille and large-print publications and The Contemporary's braille materials). Standard HTML, screen-reader friendly.
- [Visit Austin — Visitor Guide](https://www.austintexas.org/plan-a-trip/visitor-guide/) — the official general visitor guide; request a free printed copy by mail or open the digital edition. The digital "flip-book" format can be awkward with a screen reader, so the main austintexas.org site is often the easier read for the same information. The Visitor Center tour desk (tourdesk@visitaustin.org, (512) 478-0098) also books downtown walking and bus tours.
- [Travel Texas — Official Texas Travel Guide](https://www.traveltexas.com/plan-ahead/travel-guide/) — the statewide guide from the Texas tourism office, in print or online; useful if you add any day trips beyond Austin.
- [accessibleGO — Top 10 Accessible Attractions in Austin](https://accessiblego.com/articles/Top_10_Accessible_Attractions_in_Austin) — a third-party accessible-travel roundup. Helpful for an overview, though it leans toward mobility access and the page requires JavaScript to load.
